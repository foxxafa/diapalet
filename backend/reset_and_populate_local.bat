...
echo [1/5] Container ve veritabani volume'u siliniyor...
docker compose down -v

echo [2/5] Servisler yeniden baslatiliyor... (Veritabani bos olarak olusturulacak)
docker compose up -d

echo.
echo [3/5] Veritabani sunucusunun ayaga kalkmasi bekleniyor...
:check_db
...
echo [4/5] Web sunucusunun ayaga kalkmasi bekleniyor...
:check_web
timeout /t 5 /nobreak > NUL
...
echo [5/5] Tum test verileri (depolar, raflar, urunler, calisanlar, siparisler) veritabanina ekleniyor...
