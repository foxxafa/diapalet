            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  labelText: "Sipariş No veya Tedarikçi Ara",
              ...
              child: FutureBuilder<List<PurchaseOrder>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.data == null || snapshot.data!.isEmpty) {
                    return const Center(child: Text("Aktarılacak sipariş bulunamadı."));
                  }
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          title: Text(order.poId ?? 'Bilinmeyen Sipariş'),
                          subtitle: Text(
                            "${order.supplierName ?? 'Tedarikçi belirtilmemiş'}\n"
                                // DÜZELTME: Nullable DateTime için kontrol eklendi.
                                "${order.date != null ? DateFormat('dd.MM.yyyy').format(order.date!) : 'Tarih Yok'}",
                          ),
                          isThreeLine: true,
